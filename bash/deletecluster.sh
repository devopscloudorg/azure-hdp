#!/bin/bash
#This script deletes all the services associated with the cluster defined in hdpsetup.sh files
...
function deletecluster {
	...
	#we will not delete the vnet, storage account and affinity group but we will echo these command so users can
...
case "$-" in
	*i*) choose N "Do you want to delete all the services assocaited with this cluster, select Y or N:" deletecluster end 
	;;
	*) deletecluster
	;;
esac

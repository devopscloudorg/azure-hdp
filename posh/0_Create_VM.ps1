...
.EXAMPLE 
  .\0_Create-VM.ps1 -imageName "b39f27a8b8c64d52b05eac6a62ebad85__Ubuntu_DAILY_BUILD-saucy-13_10-amd64-server-20140119-en-us-30GB" `
    ...
    -vmName "hadoopazure" -cloudServiceName "hadoopazure" -affinityGroupName "hadoopazureAG" -virtualSubnetname "App" -virtualNetworkName "Hadoop-Networkhadoop" -numofDisks 2 
...
if($?)
{
    Write-Output "Service $cloudServiceName was created successfully. result is $($result.OperationDescription)"
}
else
{                    
